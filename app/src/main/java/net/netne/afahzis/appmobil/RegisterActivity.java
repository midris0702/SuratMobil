...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog.show();
        progressUpload = new ProgressDialog(RegisterActivity.this);
        ...
        mWebView.setWebChromeClient(new WebChromeClient(){
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
                ...
                i.setType("*/*");
                RegisterActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"), UploadActivity.REQUEST_SELECT_FILE);
                return true;
            }
            ...
            public void openFileChooser(ValueCallback uploadMsg, String acceptType) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                RegisterActivity.this.startActivityForResult(
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                ...
                i.addCategory(Intent.CATEGORY_OPENABLE);
                i.setType("*/*");
                RegisterActivity.this.startActivityForResult(Intent.createChooser(i, "File Browser"), RegisterActivity.FILECHOOSER_RESULTCODE);
            ...
            public void onProgressChanged(WebView view, int progress)
            {
                ...
                RegisterActivity.this.setProgress(progress * 1000);
        ...
        mWebView.loadUrl("https://trayektest.000webhostapp.com/Trayek2_3/mobile/register/?idUser=" + sharedpreferences.getString(AppVar.USER_ID,null) + "&type="+typeTrayek);
