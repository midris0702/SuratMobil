    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if(mWebView.getUrl().equals("http://trayek.dawoodtravel.co.id/mobile/pembayaran/?idUser=" + sharedpreferences.getString(AppVar.USER_ID,null) + "&type="+typeTrayek)){
                    cekhalaman=1;
                }
            }
        ...
        mWebView.loadUrl("http://trayek.dawoodtravel.co.id/mobile/pembayaran/?idUser=" + sharedpreferences.getString(AppVar.USER_ID,null)+"&type="+typeTrayek);
